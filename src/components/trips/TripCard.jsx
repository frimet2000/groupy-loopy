...
import { Calendar, MapPin, Users, Clock, Mountain, Droplets, TreePine, Dog, Tent } from 'lucide-react';
...
export default function TripCard({ trip }) {
  ...
  return (
    <Link to={createPageUrl('TripDetails') + `?id=${trip.id}`}>
      <Card className="group overflow-hidden hover:shadow-xl transition-all duration-500 cursor-pointer bg-white border-0 shadow-md">
