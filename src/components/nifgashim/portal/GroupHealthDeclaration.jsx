...
export default function GroupHealthDeclaration({ accepted, onAccept, leaderName }) {
  ...
  const declarations = {
    he: {
      ...
      declarationText: `אני ${leaderName} ראש קבוצת _____ מצהיר כי קראתי את כל הוראות הבטיחות ופרטי המסלולים אליהם נרשמנו. 2. וידאתי שכל חברי הקבוצה בריאים וכשירים להשתתף במסלולים אליהם נרשמנו 3. אני אחראי להתנהגות תקינה של חברי קבוצתי בהתאם להוראות הבטיחות ונחיות מארגני המסע. 4. אני אדווח למארגני המסע על כל בעיה רפואית או בטיחותית שתיווצר מזמן השתתפותנו במסע, ואפעל בהתאם להוראותיהם.`,
