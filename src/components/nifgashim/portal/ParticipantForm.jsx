        ...
        <div className="space-y-4">
          {userType !== 'group' && (
            <>
              ...
              {(userType !== 'individual' || participants.length === 0) && (userType === 'individual' || (participants.length < 2 && hasSpouse) || participants.length < 1 || participants.length >= (spouseExists ? 2 : 1)) && (
                <>
