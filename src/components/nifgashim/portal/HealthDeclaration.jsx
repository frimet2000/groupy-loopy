...
const translations = {
  he: {
    title: 'הצהרת בריאות משפחתית',
    subtitle: 'אנא קרא בעיון את ההצהרה הבאה',
    section1: 'הצהרת בריאות',
    section1Text: `אני ובני משפחתי המשתתפים במסע מצהירים כי:

• כולנו בריאים ומסוגלים להשתתף במסע זה
• אין למי מאיתנו מגבלות רפואיות המונעות השתתפות בפעילות פיזית
• אנו מתחייבים לדווח על כל בעיה רפואית במהלך המסע`,
