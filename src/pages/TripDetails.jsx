        ...
        >
          ...
          <Tabs defaultValue="details" className="w-full">
            <div className="w-full mb-4">
              <TabsList className="flex flex-wrap md:grid md:grid-flow-col md:grid-rows-2 md:auto-cols-fr w-full items-stretch gap-1.5 md:gap-2 h-auto bg-gradient-to-r from-white via-gray-50 to-white border-2 border-gray-200/50 shadow-xl rounded-xl p-2 md:p-3 text-xs md:text-sm" dir={language === 'he' ? 'rtl' : 'ltr'}>
