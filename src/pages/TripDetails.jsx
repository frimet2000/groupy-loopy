          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <div className="w-full mb-4">
              <TabsList className="flex flex-wrap lg:grid lg:grid-cols-8 lg:auto-rows-fr w-full items-stretch gap-1.5 lg:gap-2 h-auto bg-gradient-to-r from-white via-gray-50 to-white border-2 border-gray-200/50 shadow-xl rounded-xl p-2 lg:p-3 text-xs md:text-sm" dir={language === 'he' ? 'rtl' : 'ltr'}>
                {/* Check if tab should be hidden - organizers always see all tabs */}
                {(canEdit || !trip.hidden_tabs?.includes('details')) && (
                ...
                {(canEdit || !trip.hidden_tabs?.includes('navigate')) && (
                ...
                {(canEdit || !trip.hidden_tabs?.includes('participants')) && (
                ...
                {(canEdit || !trip.hidden_tabs?.includes('equipment')) && (
                ...
                {(canEdit || !trip.hidden_tabs?.includes('itinerary')) && (
                ...
                {(canEdit || !trip.hidden_tabs?.includes('budget')) && (
                ...
                {(canEdit || !trip.hidden_tabs?.includes('social')) && (
                ...
                <>
                    ...
                    {(canEdit || !trip.hidden_tabs?.includes('experiences')) && (
                    ...
                    {(canEdit || !trip.hidden_tabs?.includes('reminders')) && (
                    ...
                    {(canEdit || !trip.hidden_tabs?.includes('contributions')) && (
                    ...
                    {(canEdit || !trip.hidden_tabs?.includes('invite')) && (
                    ...
                    {(canEdit || !trip.hidden_tabs?.includes('waiver')) && (
