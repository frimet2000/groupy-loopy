        ...
        >
          ...
          <Tabs defaultValue="details" className="w-full">
            <div className="w-full mb-4">
              <TabsList className="flex flex-wrap sm:flex-nowrap w-full items-center gap-1.5 h-auto bg-gradient-to-r from-white via-gray-50 to-white border-2 border-gray-200/50 shadow-xl rounded-xl p-2 sm:p-3 text-xs sm:text-sm" dir={language === 'he' ? 'rtl' : 'ltr'}>
                <TabsTrigger value="details" className="flex items-center gap-2 whitespace-nowrap data-[state=active]:bg-gradient-to-br data-[state=active]:from-emerald-500 data-[state=active]:to-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-emerald-500/50 data-[state=active]:border-2 data-[state=active]:border-emerald-400 text-gray-600 py-2 px-2 sm:py-3 sm:px-4 rounded-xl transition-all duration-300 hover:scale-105">
